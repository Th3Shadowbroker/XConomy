...
import net.th3shadowbroker.Thirdparty.Essentials.Thirdparty_Essentials;
...
public class Thirdparty 
{
    ...
    private void Setup()
    {
        ...
        //Essentials thirdparty addon
        if ( Bukkit.getPluginManager().isPluginEnabled( "Essentials" ) )
        {
            Thirdparty_Essentials Essentials = new Thirdparty_Essentials( loader );
        }
